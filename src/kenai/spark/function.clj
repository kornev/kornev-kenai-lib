...
(defmacro ^:private gen-function
  ...
  `AClojureSerializable` and implements interfaces for compatibility with Spark."
  [fn-name constructor]
  (let [class-sym (symbol (str "kenai.spark.function." fn-name))]
    ^:cljfmt/ignore
...
(gen-function FlatMapFn1 flat-map-fn1)
(gen-function FlatMapFn2 flat-map-fn2)
(gen-function Fn1 fn1)
(gen-function Fn2 fn2)
(gen-function Fn3 fn2)
(gen-function PairFlatMapFn1 pair-flat-map-fn1)
(gen-function PairFn1 pair-fn1)
(gen-function VoidFn1 void-fn1)
(gen-function ComparatorFn2 comparator-fn2)
